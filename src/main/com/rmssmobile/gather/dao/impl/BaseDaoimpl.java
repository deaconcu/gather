package com.rmssmobile.gather.dao.impl;
...
import com.rmssmobile.gather.dao.BaseDao;
	...
	public List<T> findByPage(int page, final int length) {		
		...
		List<T> list = getHibernateTemplate().executeFind(new HibernateCallback<List<T>>() {
			...
			throws HibernateException, SQLException {
				String s = "select f from " + entityClassSimpleName + " as f order by posttime desc";
